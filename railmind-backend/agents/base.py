...
def get_mock_response(system: str, user: str) -> str:
    ...
    if "sentinel" in system_lower:
        return json.dumps({
            ...
            "severity": "critical",
            "confidence": 0.94,
            "reasoning": "[MOCK MODE] Vibration frequency of 142Hz with 9.4mm amplitude is a clear indicator of a rail fracture on Section 47B."
        })
        ...
        return json.dumps({
            ...
            "priority": "immediate",
            "reasoning": "[MOCK MODE] A critical rail fracture on the Western Corridor requires immediate dispatcher deployment, train reroutes, and passenger notifications."
        })
        ...
        return json.dumps({
            ...
            "reasoning": "[MOCK MODE] Crew GAMMA-1 is the nearest emergency response unit located at the Surat depot (25 mins away)."
        })
        ...
        return json.dumps({
            ...
            "reasoning": "[MOCK MODE] Rerouted Rajdhani and Tejas Expresses to prevent delays and maintain safety."
        })
